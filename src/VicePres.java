...
public class VicePres extends JFrame implements ActionListener{
    Main main = new Main();
    JButton pick;
    JButton cancel;
    ButtonGroup choose;
    ...
    VicePres(){
        ...
        JLabel position_l = new JLabel("Vice President Position");
        ...
        try{
            ...
            ResultSet rs = stat.executeQuery("SELECT * FROM vicepresidentResult");
        ...
        if(e.getSource() == pick){
            ...
            for(Enumeration<AbstractButton> buttons = choose.getElements(); buttons.hasMoreElements();){
                ...
                if(button.isSelected()){
                    main.pickedvicepres = button.getText();
                    break;
                }
            }
